...
#被験者ループ
for grf in tqdm(GRF_LIST):
    print(grf)

    #エクセル作成
    wbname = grf + "_" + condition + "_" + phase + ".xlsx"
    wb = openpyxl.Workbook()
    wb.save("GRF_time/" + wbname)
    ...
    for i, name in enumerate(NAME):
        ...
        file_10 = glob.glob(condition + "/" + phase + "/" + "GRF" + "/" + "10/*.csv")
        file_20 = glob.glob(condition + "/" + phase + "/" + "GRF" + "/" + "20/*.csv")
        file_30 = glob.glob(condition + "/" + phase + "/" + "GRF" + "/" + "30/*.csv")
        file_40 = glob.glob(condition + "/" + phase + "/" + "GRF" + "/" + "40/*.csv")
        file_50 = glob.glob(condition + "/" + phase + "/" + "GRF" + "/" + "50/*.csv")
        file_60 = glob.glob(condition + "/" + phase + "/" + "GRF" + "/" + "60/*.csv")
        file_70 = glob.glob(condition + "/" + phase + "/" + "GRF" + "/" + "70/*.csv")
        file_80 = glob.glob(condition + "/" + phase + "/" + "GRF" + "/" + "80/*.csv")
        file_90 = glob.glob(condition + "/" + phase + "/" + "GRF" + "/" + "90/*.csv")
        file_100 = glob.glob(condition + "/" + phase + "/" + "GRF" + "/" + "100/*.csv")

        book = openpyxl.load_workbook("GRF_time/" + wbname)

...
for com in tqdm(CoM_LIST):
    ...
    wb.save("CoM_velocity_time/" + wbname)
    ...
    for i, name in enumerate(NAME):
        ...
        file_10 = glob.glob(condition + "/" + phase + "/" + "CoM_velocity" + "/" + "10/*.csv")
        file_20 = glob.glob(condition + "/" + phase + "/" + "CoM_velocity" + "/" + "20/*.csv")
        file_30 = glob.glob(condition + "/" + phase + "/" + "CoM_velocity" + "/" + "30/*.csv")
        file_40 = glob.glob(condition + "/" + phase + "/" + "CoM_velocity" + "/" + "40/*.csv")
        file_50 = glob.glob(condition + "/" + phase + "/" + "CoM_velocity" + "/" + "50/*.csv")
        file_60 = glob.glob(condition + "/" + phase + "/" + "CoM_velocity" + "/" + "60/*.csv")
        file_70 = glob.glob(condition + "/" + phase + "/" + "CoM_velocity" + "/" + "70/*.csv")
        file_80 = glob.glob(condition + "/" + phase + "/" + "CoM_velocity" + "/" + "80/*.csv")
        file_90 = glob.glob(condition + "/" + phase + "/" + "CoM_velocity" + "/" + "90/*.csv")
        file_100 = glob.glob(condition + "/" + phase + "/" + "CoM_velocity" + "/" + "100/*.csv")

        book = openpyxl.load_workbook("CoM_velocity_time/" + wbname)
        ...
        book.create_sheet()
        book.save("CoM_velocity_time/" + wbname)
